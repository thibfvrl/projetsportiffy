...
if (isset($_SESSION['id_utilisateur']) && !isset($_SESSION['nomprenom'])) {
    require_once 'AuthentificationClient.php';
}
if (isset($_SESSION['id_coach']) && !isset($_SESSION['nom'])) {
    require_once 'AuthentificationCoach.php';
}
?>
...
<main>
  <h1>Choisissez votre activité sportive souhaitée</h1>

  <div class="role-selection">
    <a href="musculation.php" class="role-card">
      <img src="coach/muscu.jpeg" alt="Client">
      <span>Musculation</span>
    </a>
    <a href="fitness.php" class="role-card">
      <img src="coach/fitness.jpeg" alt="Coach">
      <span>Fitness</span>
    </a>
    <a href="cyclisme.php" class="role-card">
      <img src="coach/velo.jpg" alt="Administrateur">
      <span>Cyclisme</span>
    </a>
     <a href="cardio.php" class="role-card">
      <img src="coach/cardio.jpg" alt="Coach">
      <span>Cardio</span>
    </a>
     <a href="cours-collectif.php" class="role-card">
      <img src="coach/coursco.jpg" alt="Coach">
